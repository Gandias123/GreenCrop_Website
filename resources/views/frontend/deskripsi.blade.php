							...
							<ul>
								...
								<li><a href="/product">Product</a>
									<ul class="sub-menu">
										...
										<li class="current-list-item"><a href="/deskripsi">Deskripsi</a></li>
									</ul>
								</li>
				...
				<div class="col-lg-4">
					<div class="sidebar-section">
						<div class="recent-posts">
							<h4>Recent Posts</h4>
							<ul>
								<li><a href="/deskripsi">You will vainly look for fruit on it in autumn.</a></li>
								<li><a href="/deskripsi">A man's worth has its season, like tomato.</a></li>
								<li><a href="/deskripsi">Good thoughts bear good fresh juicy fruit.</a></li>
								<li><a href="/deskripsi">Fall in love with the fresh orange</a></li>
								<li><a href="/deskripsi">Why the berries always look delecious</a></li>
							</ul>
						</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="footer-box about-widget">
						...
						<p>GrowHarvest adalah aplikasi inovatif yang dirancang khusus untuk para petani dan pemangku kepentingan di sektor pertanian.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
